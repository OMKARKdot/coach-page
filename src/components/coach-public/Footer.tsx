      ...
      <div className="bg-slate-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-xs uppercase tracking-wider">{profile?.institute_type}</p>
                </div>
              </div>
                ...
                {[
                  ...
                  social.href && (
                    <a
                      ...
                      className="w-10 h-10 bg-white/5 hover:bg-blue-600 rounded-xl flex items-center justify-center transition-all hover:-translate-y-1 hover:shadow-lg hover:shadow-blue-600/20"
            ...
            {/* Quick Links */}
            <div>
              <h4 className="font-heading text-sm font-bold uppercase tracking-wider text-slate-300 mb-6">Quick Links</h4>
            ...
            {/* Contact */}
            <div>
              <h4 className="font-heading text-sm font-bold uppercase tracking-wider text-slate-300 mb-6">Contact Us</h4>
          ...
          <div className="border-t border-slate-800 py-6 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="text-slate-500 text-sm">
              Website by{" "}
              <a href="https://icoded.in" className="text-blue-400 hover:text-blue-300 transition-colors font-medium">
                iCoded Automation
              </a>
            </p>
          </div>
