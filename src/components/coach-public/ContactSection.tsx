      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-50 border border-indigo-100 rounded-full mb-6">
            ...
            <span className="text-xs font-bold text-indigo-700 uppercase tracking-widest">Location</span>
          </div>
          <h2 className="premium-section-title">Visit Our Campus</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
          <div className="lg:col-span-3">
            <div className="h-[450px] rounded-3xl overflow-hidden premium-card ring-1 ring-slate-100 premium-card-hover">
          ...
          <div className="lg:col-span-2 space-y-4">
            {[
              ...
              <div key={i} className="flex gap-4 p-5 premium-card rounded-2xl premium-card-hover">
            ...
            <div className="bg-gradient-to-r from-indigo-50 to-purple-50 p-6 rounded-2xl border border-indigo-100">
              <h4 className="font-heading font-bold text-indigo-900 mb-2">Inquiry Hours</h4>
              <div className="space-y-1">
                <p className="text-indigo-800 text-sm">Monday - Saturday: <span className="font-bold">8 AM to 8 PM</span></p>
                <p className="text-indigo-800 text-sm">Sunday: <span className="font-bold">9 AM to 1 PM</span></p>
              </div>
            </div>
          </div>
        </div>
